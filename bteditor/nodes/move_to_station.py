...
@register_node(MOVE_TO_STATION)
class Move_to_station(CalcNode):
    icon = "icons/thunder.png"
    op_code = MOVE_TO_STATION
    op_title = "Move_to_station"
    content_label_objname = "move_to_station_node"

    def __init__(self, scene):
        CalcNode.__init__(self,scene, inputs=[1], outputs=[])
        pt.behaviour.Behaviour.__init__(self, name="Move_to_station")
        self.eval()
...
class move_to_station_(py_trees.behaviour.Behaviour):   
