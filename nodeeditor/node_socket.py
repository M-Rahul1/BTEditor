...
class Socket(Serializable):
    ...
    def __init__(self, node:'Node', index:int=0, position:int=TOP_LEFT, socket_type:int=1, multi_edges:bool=True, count_on_this_node_side:int=1, is_input:bool=False):
        """
    ...
    def determineMultiEdges(self, data:dict) -> bool:
        ...
        if 'multi_edges' in data:
            ...
            return data['position'] in (BOTTOM_LEFT, BOTTOM_RIGHT)
